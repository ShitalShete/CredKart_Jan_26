...
when the manual testing is near to completed.
and build is also very much stable
...
class Test_User_Profile :
    ...
    @allure.issue("User Verification")
    ...
    def test_verify_Credkart_url_001(self):
        ...
        if self.driver.title == "CredKart":
            ...
            #self.driver.save_screenshot(".\\Screenshots\\test_verify_Credkart_url_001_pass.png")
            screenshot_path = ".\\Screenshots\\test_verify_Credkart_url_001_pass.png"
            self.driver.save_screenshot(screenshot_path)
            allure.attach.file(screenshot_path, name="User Login Successful",attachment_type=allure.attachment_type.PNG)
            ...
            screenshot_path = ".\\Screenshots\\test_verify_Credkart_url_001_fail.png"
            self.driver.save_screenshot(screenshot_path)
            allure.attach.file(screenshot_path,name="User Login Fail",attachment_type=allure.attachment_type.PNG)
            assert False
    ...
    def test_Credkart_login_002(self):
        ...
        if self.lp.verify_menu_button_visibility() == "pass":
            ...
            screenshot_path = ".\\Screenshots\\test_verify_Credkart_login_002_pass.png"
            self.driver.save_screenshot(screenshot_path)
            allure.attach.file(screenshot_path, name="User login Successful",attachment_type=allure.attachment_type.PNG)
            ...
            screenshot_path = ".\\Screenshots\\test_verify_Credkart_login_002_fail.png"
            self.driver.save_screenshot(screenshot_path)
            allure.attach.file(screenshot_path, name="User Login Fail",attachment_type=allure.attachment_type.PNG)
            assert False, "User Login Fail"
    ...
    @allure.title("def test_Credkart_registration_003")
    @allure.severity(allure.severity_level.CRITICAL)
    @allure.epic("Epic:User_Registration")
    @allure.description("This testcases is to validate credkart website registration")
    ...
    def test_Credkart_registration_003(self):
        ...
        if self.rp.verify_menu_button_visibility() == "pass":
            ...
            screenshot_path = ".\\Screenshots\\test_verify_Credkart_Registration_003_pass.png"
            self.driver.save_screenshot(screenshot_path)
            allure.attach.file(screenshot_path, name="User Registration Successful",attachment_type=allure.attachment_type.PNG)
            self.log.info(f"Clicking on menu button")
            ...
            screenshot_path = ".\\Screenshots\\test_verify_Credkart_Registration_003_fail.png"
            self.driver.save_screenshot(screenshot_path)
            allure.attach.file(screenshot_path, name="User Registration fail",attachment_type=allure.attachment_type.PNG)
...
# 27th jan 2026 --> config, read properties, html report environment, logger
