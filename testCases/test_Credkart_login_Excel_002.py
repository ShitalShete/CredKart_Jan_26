    ...
    def test_Credkart_login_excel_ddt_004(self):
        ...
        for i in range(2,self.rows +1):
            ...
            if self.lp.verify_menu_button_visibility() == "pass" :
                ...
                screenshot_path = ".\\Screenshots\\User Login Successful.png"
                self.driver.save_screenshot(screenshot_path)
                allure.attach.file(screenshot_path, name="User login pass",attachment_type=allure.attachment_type.PNG)
                ...
                screenshot_path = ".\\Screenshots\\User Login Fail.png"
                self.driver.save_screenshot(screenshot_path)
